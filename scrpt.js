...
var partyEvent = function() {
   ...
   if (isPartyTime === false) {
      ...
      // color of the button should be "#0A8DAB" (bonus!)
	   ...
	   partyButton.style.backgroundColor = "cyan";
   }
   else {
      isPartyTime = false;
	 ...
	 partyButton.innerText = "PartyTime!!";
...
lunchSelector.addEventListener('change', lunchTimeEvent);
napSelector.addEventListener('change', napTimeEvent);